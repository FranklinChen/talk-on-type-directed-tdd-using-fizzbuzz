...
\begin{block}{\href{http://en.wikiquote.org/wiki/Colossal\_Cave\_Adventure}{Maze of twisty little conditionals, all different}}
  ...
  \item Overuse of Booleans is a type \alert{smell}
  \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}[fragile]{Swift digression: pattern matching}
...
\begin{frame}<article|handout>[fragile]{Data validation can be critical!}
    In real life, prefer non-exception type-based solution such as \href{http://eed3si9n.com/learning-scalaz/Validation.html}{Scalaz validation}.
...
\begin{frame}{Conclusion}
  ...
  \item It's a great time to be learning and using a modern typed language: there is excitement over Apple's Swift.
  \end{itemize}

  \begin{block}{Code, slides, article}
    \begin{itemize}
    \item Go to  \url{https://github.com/franklinchen/talk-on-type-directed-tdd-using-fizzbuzz}
    \item The article has more detail omitted in the presentation slides.
...
\begin{frame}{Some articles}
  \begin{itemize}
  \item \href{http://existentialtype.wordpress.com/2011/03/15/boolean-blindness/}{The problem with Booleans and conditionals}
  \item
\href{http://blog.jessitron.com/2013/06/whats-dirtier-than-comments-exceptions.html}{The problem with exceptions}
  \item
\href{http://eed3si9n.com/learning-scalaz/Validation.html}{Principled validation using types}
  \item \href{http://bluishcoder.co.nz/2014/04/11/preventing-heartbleed-bugs-with-safe-languages.html}{Preventing Heartbleed by using a dependently typed language}
  \item \href{http://www.michael-noll.com/blog/2013/12/02/twitter-algebird-monoid-monad-for-large-scala-data-analytics/}{Twitter's use of monoids}
  \item
\href{https://github.com/densh/talks/blob/master/swift-vs-scala-211-2014-06-03/Swift\%20vs\%20Scala\%202.11.pdf}{Side-by-side comparison of basic Scala and Swift constructs}
  \end{itemize}
\end{frame}
